  ...
  dashboard: {
    ...
    workflow: {
      ...
      nodes: {
        ...
        qualifySub: "of {count} leads",
        opportunity: "Opportunity level",
        opportunitySub: "High potential now",
        nextAction: "Next best action",
        nextActionSub: "Leads to act on",
        followUp: "Follow-up & appointment",
        followUpSub: "{count} follow-ups pending",
        handoff: "Handoff & recovery",
        handoffSub: "Leads to recover",
      },
    },
    activity: {
      title: "Live activity",
