...
export const en = {
  ...
  dashboard: {
    ...
    workflow: {
      ...
      nodes: {
        source: "Lead source",
        sourceSub: "{count} added today",
        qualify: "AI qualification",
        qualifySub: "{count} qualified",
        opportunity: "Opportunity level",
        opportunitySub: "{count} high potential",
        nextAction: "Next best action",
        nextActionSub: "{count} need attention",
        followUp: "Follow-up & appointment",
        followUpSub: "{count} appointment(s) booked",
        handoff: "Handoff & recovery",
        handoffSub: "{count} to recover",
      },
    },
    activity: {
      title: "Live activity",
